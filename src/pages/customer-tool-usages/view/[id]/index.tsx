...
import { getCustomerToolUsageById } from 'apiSdk/customer-tool-usages';
import { CustomerToolUsageInterface } from 'interfaces/customer-tool-usage';

function CustomerToolUsageViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Customer Tool Usage Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Customer Tool Usage Details
                  </Text>
                </Box>
                {hasAccess('customer_tool_usage', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/customer-tool-usages/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Last Used At"
                  text={
                    data?.last_used_at ? format(parseISO(data?.last_used_at as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
