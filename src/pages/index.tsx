  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless conversation with Test - Your go-to chat GPT prompt generator tool, securely storing your API key and empowering you to run your chat GPT prompts effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1675865254433-6ba341f0f00b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0Ym90fGVufDB8fHx8MTY5MzYxNTEzMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless conversation with Test - Your go-to chat GPT prompt generator tool, securely storing your API key and empowering you to run your chat GPT prompts effortlessly.`}
            </Text>
            <Box
